...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1527: (x0,x1,x2) => x0.addEventListener(x1,x2),
      ...
      _1536: (x0,x1) => x0.end(x1),
      _1537: x0 => x0.pause(),
      _1538: x0 => x0.play(),
      _1539: x0 => x0.load(),
      _1540: (x0,x1) => x0.setSinkId(x1),
      _1548: (x0,x1) => x0.getItem(x1),
      _1549: (x0,x1) => x0.removeItem(x1),
      _1550: (x0,x1,x2) => x0.setItem(x1,x2),
      _1552: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      _1553: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      _1554: x0 => globalThis.firebase_core.getApp(x0),
      _1555: () => globalThis.firebase_core.getApp(),
      _1556: (x0,x1,x2) => globalThis.firebase_core.registerVersion(x0,x1,x2),
      _1558: () => globalThis.firebase_core.SDK_VERSION,
      _1564: x0 => x0.apiKey,
      _1566: x0 => x0.authDomain,
      _1568: x0 => x0.databaseURL,
      _1570: x0 => x0.projectId,
      _1572: x0 => x0.storageBucket,
      _1574: x0 => x0.messagingSenderId,
      _1576: x0 => x0.measurementId,
      _1578: x0 => x0.appId,
      _1580: x0 => x0.name,
      _1581: x0 => x0.options,
      _1582: (x0,x1) => x0.debug(x1),
      ...
      _1585: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      _1586: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1587: (x0,x1) => x0.createScriptURL(x1),
      _1588: (x0,x1,x2) => x0.createScript(x1,x2),
      _1589: (x0,x1) => x0.appendChild(x1),
      _1590: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1590(f,arguments.length,x0) }),
      _1592: Date.now,
      _1594: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1595: s => {
      ...
      _1597: () => typeof dartUseDateNowForTicks !== "undefined",
      _1598: () => 1000 * performance.now(),
      _1599: () => Date.now(),
      _1600: () => {
      ...
      _1602: () => new WeakMap(),
      _1603: (map, o) => map.get(o),
      _1604: (map, o, v) => map.set(o, v),
      _1605: x0 => new WeakRef(x0),
      _1606: x0 => x0.deref(),
      _1613: () => globalThis.WeakRef,
      _1616: s => JSON.stringify(s),
      _1617: s => printToConsole(s),
      _1618: (o, p, r) => o.replaceAll(p, () => r),
      _1619: (o, p, r) => o.replace(p, () => r),
      _1620: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1621: s => s.toUpperCase(),
      _1622: s => s.trim(),
      _1623: s => s.trimLeft(),
      _1624: s => s.trimRight(),
      _1625: (string, times) => string.repeat(times),
      _1626: Function.prototype.call.bind(String.prototype.indexOf),
      _1627: (s, p, i) => s.lastIndexOf(p, i),
      _1628: (string, token) => string.split(token),
      _1629: Object.is,
      _1630: o => o instanceof Array,
      _1635: a => a.pop(),
      _1636: (a, i) => a.splice(i, 1),
      _1637: (a, s) => a.join(s),
      _1638: (a, s, e) => a.slice(s, e),
      _1640: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1641: a => a.length,
      _1643: (a, i) => a[i],
      _1644: (a, i, v) => a[i] = v,
      _1646: o => {
      ...
      _1647: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1649: o => o instanceof Uint8Array,
      _1650: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1651: o => o instanceof Int8Array,
      _1652: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1653: o => o instanceof Uint8ClampedArray,
      _1654: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1655: o => o instanceof Uint16Array,
      _1656: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1657: o => o instanceof Int16Array,
      _1658: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1659: o => o instanceof Uint32Array,
      _1660: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1661: o => o instanceof Int32Array,
      _1662: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1664: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1665: o => o instanceof Float32Array,
      _1666: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1667: o => o instanceof Float64Array,
      _1668: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1669: (t, s) => t.set(s),
      _1670: l => new DataView(new ArrayBuffer(l)),
      ...
      _1711: (handle) => clearTimeout(handle),
      _1712: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1713: (handle) => clearInterval(handle),
      _1714: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _1715: () => Date.now(),
      _1720: o => Object.keys(o),
      _1721: () => new AbortController(),
      _1722: x0 => x0.abort(),
      _1723: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1724: (x0,x1) => globalThis.fetch(x0,x1),
      _1725: (x0,x1) => x0.get(x1),
      _1726: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1726(f,arguments.length,x0,x1,x2) }),
      _1727: (x0,x1) => x0.forEach(x1),
      _1728: x0 => x0.getReader(),
      _1729: x0 => x0.read(),
      _1730: x0 => x0.cancel(),
      _1745: (x0,x1) => x0.key(x1),
      _1746: x0 => x0.trustedTypes,
      _1747: (x0,x1) => { x0.text = x1 },
      _1757: (s, m) => {
        try {
      ...
      _1758: (x0,x1) => x0.exec(x1),
      _1759: (x0,x1) => x0.test(x1),
      _1760: x0 => x0.pop(),
      _1762: o => o === undefined,
      _1764: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1766: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1767: o => o instanceof RegExp,
      _1768: (l, r) => l === r,
      _1769: o => o,
      _1770: o => o,
      _1771: o => o,
      ...
      _1773: o => o.length,
      _1775: (o, i) => o[i],
      _1776: f => f.dartFunction,
      _1777: () => ({}),
      _1778: () => [],
      _1780: () => globalThis,
      _1781: (constructor, args) => {
      ...
      _1783: (o, p) => o[p],
      _1784: (o, p, v) => o[p] = v,
      _1785: (o, m, a) => o[m].apply(o, a),
      _1787: o => String(o),
      _1788: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      _1789: o => {
      ...
      _1790: o => [o],
      _1791: (o0, o1) => [o0, o1],
      _1792: (o0, o1, o2) => [o0, o1, o2],
      _1793: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1807: x0 => x0.index,
      _1809: x0 => x0.flags,
      _1810: x0 => x0.multiline,
      _1811: x0 => x0.ignoreCase,
      _1812: x0 => x0.unicode,
      _1813: x0 => x0.dotAll,
      _1814: (x0,x1) => { x0.lastIndex = x1 },
      _1815: (o, p) => p in o,
      _1816: (o, p) => o[p],
      _1817: (o, p, v) => o[p] = v,
      _1818: (o, p) => delete o[p],
      _1819: x0 => x0.random(),
      _1820: (x0,x1) => x0.getRandomValues(x1),
      _1821: () => globalThis.crypto,
      _1822: () => globalThis.Math,
      _1823: Function.prototype.call.bind(Number.prototype.toString),
      _1824: Function.prototype.call.bind(BigInt.prototype.toString),
      _1825: Function.prototype.call.bind(Number.prototype.toString),
      _1826: (d, digits) => d.toFixed(digits),
      _2601: x0 => x0.error,
      _2602: x0 => x0.src,
      _2603: (x0,x1) => { x0.src = x1 },
      _2611: (x0,x1) => { x0.preload = x1 },
      _2612: x0 => x0.buffered,
      _2615: x0 => x0.currentTime,
      _2616: (x0,x1) => { x0.currentTime = x1 },
      _2617: x0 => x0.duration,
      _2622: (x0,x1) => { x0.playbackRate = x1 },
      _2635: (x0,x1) => { x0.volume = x1 },
      _2652: x0 => x0.code,
      _2653: x0 => x0.message,
      _2727: x0 => x0.length,
      _3233: (x0,x1) => { x0.type = x1 },
      _3241: (x0,x1) => { x0.crossOrigin = x1 },
      _3243: (x0,x1) => { x0.text = x1 },
      _3700: () => globalThis.window,
      _3740: x0 => x0.document,
      _3762: x0 => x0.navigator,
      _4024: x0 => x0.trustedTypes,
      _4025: x0 => x0.sessionStorage,
      _4026: x0 => x0.localStorage,
      _4151: x0 => x0.userAgent,
      _4359: x0 => x0.length,
      _6304: x0 => x0.signal,
      _6361: x0 => x0.baseURI,
      _6378: () => globalThis.document,
      _6462: x0 => x0.head,
      _8140: x0 => x0.value,
      _8142: x0 => x0.done,
      _8844: x0 => x0.url,
      _8846: x0 => x0.status,
      _8848: x0 => x0.statusText,
      _8849: x0 => x0.headers,
      _8850: x0 => x0.body,
      _12478: x0 => x0.name,
      _13196: () => globalThis.console,
      _13224: x0 => x0.name,
